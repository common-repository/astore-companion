 ...
 */
class AStore_WXR_Parser {
	function parse( $file ) {
		// Attempt to use proper XML parsers first
		if ( extension_loaded( 'simplexml' ) ) {
			$parser = new AStore_WXR_Parser_SimpleXML;
			...
			$parser = new AStore_WXR_Parser_XML;
			$result = $parser->parse( $file );
		...
		$parser = new AStore_WXR_Parser_Regex;
 ...
 */
class AStore_WXR_Parser_SimpleXML {
	function parse( $file ) {
